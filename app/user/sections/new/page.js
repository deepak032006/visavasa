  ...
  return (
    <section className="mt-[100px] px-[100px]">
      ...
      <div className="relative">
        ...
        <button
          onClick={slideRight}
          className="absolute -right-[40px] top-[100px] w-[44px] h-[44px] rounded-full bg-white shadow-[0_8px_20px_rgba(0,0,0,0.15)] flex items-center justify-center text-[20px]"
        >
          →
        </button>
      </div>
